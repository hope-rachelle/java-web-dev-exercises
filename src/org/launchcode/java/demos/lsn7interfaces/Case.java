...
public class Case {
    ...
    public Case(){
        ...
        Topping topping1 = new Topping("Pecans", .75, new ArrayList<>(Arrays.asList("nuts")));
        Topping topping2 = new Topping("Hot Fudge", 1.25, new ArrayList<>(Arrays.asList("dairy")));
        Topping topping3 = new Topping("Caramel", 1.00, new ArrayList<>(Arrays.asList("dairy")));
        Topping topping4 = new Topping("Sprinkles", .50, new ArrayList<>(Arrays.asList("red", "yellow")));
